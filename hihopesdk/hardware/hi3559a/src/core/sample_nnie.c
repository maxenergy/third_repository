    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstCnnPara, SAMPLE_SVP_NNIE_CNN_SOFTWARE_PARAM_S* pstCnnSoftWarePara)
{
	...
	SAMPLE_SVP_TRACE_INFO("SAMPLE_SVP_NNIE_Cnn_ParamInit!\n");
		usleep(5000*1000);
    ...
    SVP_BLOB_S *pstDstRoi, SVP_BLOB_S *pstClassRoiNum, HI_FLOAT f32PrintResultThresh)
{
    ...
    {
    	//printf("class[%d],score = %f \n",i,(HI_FLOAT)ps32Score[u32ScoreBias] / SAMPLE_SVP_NNIE_QUANT_BASE);
...
{
    HI_S32 s32Ret = HI_SUCCESS;
	printf("SAMPLE_SVP_NNIE_Yolov3_Deinit \n");
    /*hardware deinit*/
    if(pstNnieParam!=NULL)
    {
        s32Ret = SAMPLE_COMM_SVP_NNIE_ParamDeinit(pstNnieParam);
    ...
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV3_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    ...
    HI_U64 u64PhyAddr = 0;
    HI_U8* pu8VirAddr = NULL;
	printf("SAMPLE_SVP_NNIE_Yolov3_SoftwareInit \n");
...
******************************************************************************/
HI_S32 SAMPLE_SVP_NNIE_Yolov3_ParamInit(SAMPLE_SVP_NNIE_CFG_S* pstCfg,
    SAMPLE_SVP_NNIE_PARAM_S *pstNnieParam, SAMPLE_SVP_NNIE_YOLOV3_SOFTWARE_PARAM_S* pstSoftWareParam)
{
    HI_S32 s32Ret = HI_SUCCESS;
    /*init hardware para*/
