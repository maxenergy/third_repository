...
HI_VOID * SAMPLE_COMM_VDEC_GetPic(HI_VOID *pArgs)
{
    ...
    while(1)
    {
        ...
        {
            SAMPLE_PRT(
                "stVFrame.enPixelFormat: %d, \
                .stVFrame.u32Stride[0]: %d, \
                .stVFrame.enCompressMode: %d, \
                .stVFrame.enVideoFormat: %d,  \
                .stVFrame.enDynamicRange: %d, \
                .stVFrame.enField: %d \
                \n", 
                stVFrame.stVFrame.enPixelFormat, 
                stVFrame.stVFrame.u32Stride[0], 
                stVFrame.stVFrame.enCompressMode,
                stVFrame.stVFrame.enVideoFormat,
                stVFrame.stVFrame.enDynamicRange,
                stVFrame.stVFrame.enField
            );
