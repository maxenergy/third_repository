...
#define SAMPLE_SVP_NNIE_YOLOV3_TINY_REPORT_BLOB_NUM    2 /*yolov3 report blob num*/
#define SAMPLE_SVP_NNIE_YOLOV3_TINY_EACH_GRID_BIAS_NUM 6 /*yolov3 bias num of each grid*/
